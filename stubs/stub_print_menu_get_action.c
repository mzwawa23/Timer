...
/** User stub definition for function: int print_menu_get_action(void) */
EXTERN_C_LINKAGE int print_menu_get_action () ;
EXTERN_C_LINKAGE int CppTest_Stub_print_menu_get_action (void) 
{
    CPPTEST_STUB_CALLED("print_menu_get_action");
     ...
     *     CPPTEST_REGISTER_STUB_CALLBACK("print_menu_get_action", &CppTest_StubCallback_SomeName);
     *
     ...
     *     *__return = print_menu_get_action();
     */
